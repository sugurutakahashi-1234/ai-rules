...
metadata:
  ...
  version: "1.0"
  source: https://github.com/addyosmani/web-quality-skills/tree/main/skills/web-quality-audit
...
For a quick read-only scan of built static HTML, run:

```bash
bash scripts/analyze.sh dist
```

Treat this as a fast structural check, not a substitute for Chrome DevTools, Lighthouse, axe, or manual interaction review.
...
For measured browser performance, use the project Chrome DevTools MCP rather than a second overlapping performance skill.
