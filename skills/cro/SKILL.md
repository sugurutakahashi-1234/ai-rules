...
- **site design-system skill (if any)**: Apply the site's binding brand and visual constraints
- **seo-audit**: Check whether conversion changes preserve search visibility
- **accessibility**: Keep the path to consultation usable for all visitors
